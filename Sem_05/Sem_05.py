...
def start_task():
    decription = [
        '1. Вывести элементы списка больше 5',
        '2. Создайте из списока случайную возрастающую последовательность',
        '3. Удалите все повторяющиеся элементы',
        '4. Создайте игру в крестики-нолики.'
    ]
    for _ in decription:
        print(_)
    select = input('\nВыбрать задачу (1-4) >: ')
